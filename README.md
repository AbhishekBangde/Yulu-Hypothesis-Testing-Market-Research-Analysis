...
- Bivariate analysis between rental demand and key influencing factors  
...
This project demonstrates the **practical application of hypothesis testing and statistical analysis** to solve a real-world business problem.  
The insights derived can help Yulu improve **demand forecasting, operational efficiency, and strategic planning**.
